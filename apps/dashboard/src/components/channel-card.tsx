...
import { AdoptionCell, EmptyValue, PlatformChip } from "@/components/metrics"
...
export function ChannelCard({
  ...
  const faulty = serving.reduce(
    (total, update) => total + adoption(metrics, update, [channel.name]).faulty,
    0
  )
                ...
                row.kind === "unserved" ? (
                  ...
                  >
                    ...
                    <TableCell className="text-right">
                      <EmptyValue reason="Nothing to adopt" />
                    </TableCell>
                    <TableCell>
                      <HealthBadge healthy={0} faulty={0} />
                    </TableCell>
                    <TableCell className="pr-4 text-right">
                      <EmptyValue reason="Never published for this build" />
                    </TableCell>
                  </TableRow>
                ) : (
                  <ServingRow
...
function ServingRow({
  ...
  const numbers = adoption(metrics, update, [channel])
